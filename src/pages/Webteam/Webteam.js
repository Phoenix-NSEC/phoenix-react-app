      ...
      <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {
          webTeam.map((member)=>{
            ...
            <ul className="flex justify-center mt-4 space-x-4">
                <li>
                    <a href={member.facebook} target='_blank' className="text-[#39569c] hover:text-gray-900 ">
                ...
                <li>
                    <a href={member.linkedin} target='_blank' className="text-[#00acee] hover:text-gray-900 ">
                ...
                <li>
                    <a href={member.github} target='_blank' className="text-gray-900 hover:text-gray-900  ">
